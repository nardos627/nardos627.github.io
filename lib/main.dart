                    ...
                    FittedBox(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            const url =
                                'mailto:nardoshaddis5@gmail.com?subject=I am using your flutter project so';
                    ...
                    FittedBox(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            const url = 'https://www.instagram.com/nard1/';
                            if (await canLaunch(url)) {
                              await launch(url);
                            } else {
                              throw 'Could not launch $url';
...
var selectedloc = 0;
List<String> locs = ['ADDIS(ADD)', 'BAHIRDAR(BHR)'];
...
List<City> cities = [
  ...
  City(
    image: "assets/images/inn.jpg",
    name: "Bahirdar Tech center",
    monthyear: "2018",
    oldprice: "200",
    newprice: "100",
    discount: "58",
